...
class Blog extends CreativeWork
{
    ...
    {
        $current = $this->getProperty('blogPost');
        if ($current === null) {
            $current = [];
        ...
        $current[] = $value;
        $this->setProperty('blogPost', $current);
        return $this;
    }
     ...
     * @return $this
     */
    public function addBlogPosts($value)
    {
        $current = $this->getProperty('blogPosts');
        if ($current === null) {
            $current = [];
        } elseif (!is_array($current)) {
            $current = [$current];
        ...
        $current[] = $value;
        $this->setProperty('blogPosts', $current);
        return $this;
    }
