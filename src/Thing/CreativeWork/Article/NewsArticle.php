 ...
 * edition.
  ...
  * @return $this
  */
  public function addPrintColumn($value)
  {
  $current = $this->getProperty('printColumn');
  if ($current === null) {
  $current = [];
  ...
  $current[] = $value;
  $this->setProperty('printColumn', $current);
  return $this;
  }
  ...
  * @return $this
  */
  public function addPrintEdition($value)
  {
  $current = $this->getProperty('printEdition');
  if ($current === null) {
  $current = [];
  } elseif (!is_array($current)) {
  $current = [$current];
  ...
  $current[] = $value;
  $this->setProperty('printEdition', $current);
  return $this;
  }
 ...
 * for the exact page name (e.g. A5, B18).
  ...
  * @return $this
  */
  public function addPrintPage($value)
  {
  $current = $this->getProperty('printPage');
  if ($current === null) {
  $current = [];
  } elseif (!is_array($current)) {
  $current = [$current];
  ...
  $current[] = $value;
  $this->setProperty('printPage', $current);
  return $this;
  }
 ...
 * Washington", "Beijing/Moscow", "QUEZON CITY, Philippines".
  ...
  * @return $this
  */
  public function addDateline($value)
  {
  $current = $this->getProperty('dateline');
  if ($current === null) {
  $current = [];
  } elseif (!is_array($current)) {
  $current = [$current];
  ...
  $current[] = $value;
  $this->setProperty('dateline', $current);
  return $this;
  }
 ...
 * in which the article appeared.
  ...
  * @return $this
  */
  public function addPrintSection($value)
  {
  $current = $this->getProperty('printSection');
  if ($current === null) {
  $current = [];
  } elseif (!is_array($current)) {
  $current = [$current];
  ...
  $current[] = $value;
  $this->setProperty('printSection', $current);
  return $this;
  }
