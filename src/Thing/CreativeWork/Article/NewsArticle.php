...
class NewsArticle extends Article
{
     ...
     * @return $this
     */
    public function printColumn(?string $value): self
    {
     ...
     * @return $this
     */
    public function printEdition(?string $value): self
    {
     ...
     * @return $this
     */
    public function printSection(?string $value): self
    {
     ...
     * @return $this
     */
    public function printPage(?string $value): self
    {
...
Dateline summaries are oriented more towards human readers than towards automated processing, and can vary substantially. Some examples: "BEIRUT, Lebanon, June 2.", "Paris, France", "December 19, 2017 11:43AM Reporting from Washington", "Beijing/Moscow", "QUEZON CITY, Philippines".
     ...
     * @return $this
     */
    public function dateline(?string $value): self
    {
