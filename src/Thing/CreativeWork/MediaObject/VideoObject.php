...
class VideoObject extends MediaObject
{
  ...
  * @return $this
  */
  public function addVideoQuality($value)
  {
  $current = $this->getProperty('videoQuality');
  if ($current === null) {
  $current = [];
  } elseif (!is_array($current)) {
  $current = [$current];
  ...
  $current[] = $value;
  $this->setProperty('videoQuality', $current);
  return $this;
  }
 ...
 * series, episode, clip.
  ...
  * @return $this
  */
  public function addVideoFrameSize($value)
  {
  $current = $this->getProperty('videoFrameSize');
  if ($current === null) {
  $current = [];
  } elseif (!is_array($current)) {
  $current = [$current];
  ...
  $current[] = $value;
  $this->setProperty('videoFrameSize', $current);
  return $this;
  }
