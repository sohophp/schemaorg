...
class ProductModel extends Product
{
     ...
     * @return $this
     */
    public function predecessorOf(?ProductModel $value): self
    {
     ...
     * @return $this
     */
    public function successorOf(?ProductModel $value): self
    {
     ...
     * @return $this
     */
    public function isVariantOf(?ProductModel $value): self
    {
