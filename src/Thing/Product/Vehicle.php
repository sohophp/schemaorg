 ...
 * Typical unit code(s): KMT for kilometers, SMI for statute miles
    ...
    */
    ...
    /**
        ...
        * @param SteeringPositionValue|array|string|mixed $value
    * @return $this
    */
 ...
 * sale.
        * @param CarUsageType|string|array|mixed $value
    * @return $this
    */
 ...
 * Typical unit code(s): C62 for persons.
    ...
    */
    ...
    /**
        ...
        * @param EngineSpecification|array|string|mixed $value
    * @return $this
    */
 ...
 * source to the wheels or other relevant component(s) ("gearbox" for cars).
        * @param QualitativeValue|string|string|array|mixed $value
    * @return $this
    */
 ...
 * the vehicle's engine via the drivetrain.
        * @param DriveWheelConfigurationValue|string|array|mixed $value
    * @return $this
    */
