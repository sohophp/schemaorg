 ...
 * [[ProductGroup]] vary, e.g. their size, color etc. Schema.org properties can
 * be referenced by their short name e.g. "color"; terms defined elsewhere can
 * be referenced with their URIs.
        * @param array|string|mixed $value
    * @return $this
    */
