...
class AnatomicalStructure extends MedicalEntity
{
    ...
    * @param AnatomicalStructure|array|string $value
    * @return $this
    * @deprecated use setSubStructure
    */
    ...
    * @param AnatomicalSystem|array|string $value
    * @return $this
    * @deprecated use setPartOfSystem
    */
