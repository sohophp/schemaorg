...
class LodgingBusiness extends LocalBusiness
{
     ...
     */
     ...
     public function checkinTime( $value):self
     {
     ...
     */
     ...
     public function petsAllowed( $value):self
     {
     ...
     */
     ...
     public function amenityFeature(?LocationFeatureSpecification $value):self
     {
     ...
     */
     ...
     public function starRating(?Rating $value):self
     {
     ...
     */
     ...
     public function checkoutTime( $value):self
     {
