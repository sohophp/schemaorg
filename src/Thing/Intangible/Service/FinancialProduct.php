...
class FinancialProduct extends Service
{
     ...
     */
     ...
     public function annualPercentageRate(?QuantitativeValue $value):self
     {
     ...
     */
     ...
     public function interestRate(?QuantitativeValue $value):self
     {
     ...
     */
     ...
     public function feesAndCommissionsSpecification( $value):self
     {
