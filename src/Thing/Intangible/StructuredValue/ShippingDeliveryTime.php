 ...
 * method is on site pickup. Typical properties: minValue, maxValue, unitCode (d
 * for DAY).  This is by common convention assumed to mean business days (if a
 * unitCode is used, coded as "d"), i.e. only counting days when the business
 * normally operates.
        * @param array|string|mixed $value
    * @return $this
    */
