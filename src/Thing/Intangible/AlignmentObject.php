...
class AlignmentObject extends Intangible
{
     ...
     */
     ...
     public function targetDescription(?string $value):self
     {
     ...
     */
     ...
     public function alignmentType(?string $value):self
     {
     ...
     */
     ...
     public function targetUrl(?string $value):self
     {
     ...
     */
     ...
     public function targetName(?string $value):self
     {
     ...
     */
     ...
     public function educationalFramework(?string $value):self
     {
