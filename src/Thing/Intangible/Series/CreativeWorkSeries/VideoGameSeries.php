...
class VideoGameSeries extends CreativeWorkSeries
{
     ...
     */
     ...
     public function gameItem(?Thing $value):self
     {
     ...
     */
     ...
     public function gamePlatform( $value):self
     {
     ...
     */
     ...
     public function cheatCode(?CreativeWork $value):self
     {
     ...
     */
     ...
     public function characterAttribute(?Thing $value):self
     {
     ...
     */
     ...
     public function gameLocation( $value):self
     {
     ...
     */
     ...
     public function playMode(?GamePlayMode $value):self
     {
     ...
     */
     ...
     public function quest(?Thing $value):self
     {
     ...
     */
     ...
     public function numberOfPlayers(?QuantitativeValue $value):self
     {
