 ...
 *     }
 * 
 * Use Text for incentives that are limited based on other criteria, for example
 * if an incentive is only available to recipients making 120% of the median
 * poverty income in their area.
 ...
 * should be 'P1' and the unitText should be '%', while valueReference should be
 * used for holding the currency type. For example, "You can claim up to 30% of
 * the total cost of installation, up to a maximum of $7,500" would be:</p>
 *     {
 *         "@type": "QuantitativeValue",
 *         "value": 30,
 *         "unitCode": "P1",
 ...
 *     }
 * <p>[[LoanOrCredit]]: Use for incentives that are loan based. For example, a
 * loan of $4,000 - $50,000 with a repayment term of 10 years, interest free
 * would look like:</p>
 *     {
 *         "@type": "LoanOrCredit",
 *         "loanTerm": {
