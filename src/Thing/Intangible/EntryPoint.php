...
class EntryPoint extends Intangible
{
     ...
     */
     ...
     public function actionApplication(?SoftwareApplication $value):self
     {
     ...
     */
     ...
     public function application(?SoftwareApplication $value):self
     {
     ...
     */
     ...
     public function actionPlatform( $value):self
     {
     ...
     */
     ...
     public function httpMethod(?string $value):self
     {
     ...
     */
     ...
     public function encodingType(?string $value):self
     {
